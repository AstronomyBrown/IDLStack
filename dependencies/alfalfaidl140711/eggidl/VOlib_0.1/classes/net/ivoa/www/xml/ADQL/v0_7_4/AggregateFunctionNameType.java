...
public class AggregateFunctionNameType implements java.io.Serializable {
    ...
    public static AggregateFunctionNameType fromValue(java.lang.String value)
        ...
        AggregateFunctionNameType enumeration = (AggregateFunctionNameType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AggregateFunctionNameType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/ADQL/v0.7.4", "aggregateFunctionNameType"));
    }
    /**
