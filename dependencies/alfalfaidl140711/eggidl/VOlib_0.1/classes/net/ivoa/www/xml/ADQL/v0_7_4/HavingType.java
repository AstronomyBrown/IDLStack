...
public class HavingType  implements java.io.Serializable {
    ...
    /**
     * Gets the condition value for this HavingType.
     * 
     * @return condition
     */
    ...
    /**
     * Sets the condition value for this HavingType.
     * 
     * @param condition
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HavingType)) return false;
        HavingType other = (HavingType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HavingType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/ADQL/v0.7.4", "havingType"));
