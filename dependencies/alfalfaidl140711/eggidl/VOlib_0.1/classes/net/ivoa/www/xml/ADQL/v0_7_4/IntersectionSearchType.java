...
public class IntersectionSearchType  extends net.ivoa.www.xml.ADQL.v0_7_4.SearchType  implements java.io.Serializable {
    private net.ivoa.www.xml.ADQL.v0_7_4.SearchType[] condition;

    public IntersectionSearchType() {
    }


    /**
     * Gets the condition value for this IntersectionSearchType.
     * 
     * @return condition
     */
    ...
    /**
     * Sets the condition value for this IntersectionSearchType.
     * 
     * @param condition
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IntersectionSearchType)) return false;
        IntersectionSearchType other = (IntersectionSearchType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IntersectionSearchType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/ADQL/v0.7.4", "intersectionSearchType"));
