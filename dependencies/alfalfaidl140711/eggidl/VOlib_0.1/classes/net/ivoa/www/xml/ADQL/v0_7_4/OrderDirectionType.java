...
public class OrderDirectionType implements java.io.Serializable {
    ...
    public static OrderDirectionType fromValue(java.lang.String value)
        ...
        OrderDirectionType enumeration = (OrderDirectionType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OrderDirectionType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.ivoa.net/xml/ADQL/v0.7.4", "orderDirectionType"));
    }
    /**
