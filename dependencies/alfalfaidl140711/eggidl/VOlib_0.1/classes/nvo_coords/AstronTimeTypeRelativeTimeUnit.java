...
public class AstronTimeTypeRelativeTimeUnit implements java.io.Serializable {
    ...
    public static AstronTimeTypeRelativeTimeUnit fromValue(java.lang.String value)
        ...
        AstronTimeTypeRelativeTimeUnit enumeration = (AstronTimeTypeRelativeTimeUnit)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AstronTimeTypeRelativeTimeUnit.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:nvo-coords", "astronTimeTypeRelativeTimeUnit"));
    }
    /**
