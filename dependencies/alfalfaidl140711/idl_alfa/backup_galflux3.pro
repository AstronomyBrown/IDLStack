...
if (gfstate.cen_ell_dec[0] gt 3.5 AND gfstate.cen_ell_dec[0] lt 16.5) then begin
...
print, ''
print, 'Initializing GalFLUX v3.0. pointing correction applied for 3.5 < dec < 16.5 AND 23.5 < dec < 28.5.'
print, ''
