...
; MH: 12Jan10 - write scan# as i9.9 in output file name because of scan# issues
;                  in CIMA Jan 11-12, 2010. Not a big deal.
;
...
name=string(rah,ram,ras,sign,decd,decm,decs,scan,format='("d",3i2.2,a1,3i2.2,".",i9.9)')
ira00=rah*10000+ram*100+ras
idec00=decd*10000+decm*100+decs
if sign eq '-' then idec00=-idec00
