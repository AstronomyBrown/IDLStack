...
;
;       May 9, 2010      M.H. - change AGC call to agcnorthminus1
;
;
;----------------------------------------------------------
...
cleangrid = {name: grid.name, epoch: grid.epoch, czmin: grid.czmin, nz: grid.nz, velarr: grid.velarr, $
	...
	d: cleand, cont: c_cleand, raw_d: dbox, raw_cont: cbox }		
...
cleangrid = {name: grid.name, epoch: grid.epoch, czmin: grid.czmin, nz: grid.nz, velarr: grid.velarr, $
	ramin: viewstate.ramin, decmin: viewstate.decmin, deltara: grid.deltara, deltadec: grid.deltadec, $
	nx: n_elements(cleand[0,*,0]), ny: n_elements(cleand[0,0,*]), $
	d: cleand, w: grid.w, cont: c_cleand, cw: grid.cw, raw_d: dbox, raw_cont: cbox }		
...
beam=dblarr(nbx,nby)
hpfwx = 3.0  	;hpfwx=sqrt(3.3^2+cleangrid.wf_fwhm^2)
hpfwy = 3.0	;hpfwy=sqrt(3.8^2+cleangrid.wf_fwhm^2)
