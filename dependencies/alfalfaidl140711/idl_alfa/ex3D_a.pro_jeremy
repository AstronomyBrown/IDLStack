;NAME:
; ex3D_a.pro - Finds gaussian absorption signals within a 3D tile and produces a list of candidates
;
;INPUT:
...
;
;EXAMPLE:
; ex3D_a,grid,sources,res,SN=4.5,GALHI='yes'
;
...
;Apr. 21, 2007 (JKD)- Modified original code to search for gaussian absorption
;		      lines and narrowed the template a bit, close to the 
;		      resolution limit.
; Mar 5, 2013 (mph)   Installed Jeremy's code here.
;--------------------------------------------------------------------------------------------------------------
...
for i=0,nx-1 do begin
 for j=0,ny-1 do begin
  ...
  z[i,j]=parameter[4]*exp(-exponent) ; minus (JKD)
 endfor
endfor
return,z
...
pro ex3D_a,gr,sources,res,SN=snth,GALHI=galHI
