...
;
;  17Mar10 - DK - Fixed error checking in center_rfi
;
;  08Aug12 - DS - Calls dr9 for imaging, dr7 if in spring or fall <1
;            or 15 deg
;
...
if (nlo gt nhi) then begin ;; Added error checking here DK 2010.03.17
    temp = nlo
    nlo=nhi
    nhi=temp
endif
...
;         url='http://skyservice.pha.jhu.edu/DR8/ImgCutout/getjpeg.aspx?ra='+$
        ...
        if (rahr gt 20) or (rahr lt 5) and (decdeg ne 1) and (decdeg ne 15) then $
