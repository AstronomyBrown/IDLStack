...
xyouts, vmin-0.07*dx, -13, 'No position correction applied (GALflux v2.0)', charsize=0.5
...
print, 'Initializing GalFLUX v2.0...'
...
gfstate={baseID:0L, $         ;ID of base widget
         ...
         RA_opt:0.0D, $
         Dec_opt:0.0D, $
         correction:0, $   ;correction pointing code - not used in Galflux2
         buttonnostatus:0L, $
         buttondetection:0L, $
         buttonprior:0L, $
         buttonmarginal:0L, $
