...
;	Dec 08, 2011	rg	New pointing corrections for Spring+17  (line ~1858)

;	Apr 06, 2012	rg	New pointing corrections for Fall+23

;	Jun 15, 2012	rg	Pointing corrections for Fall+01

;	Jan 10, 2013	rg	Pointing corrections for Spr+21

;	Feb 12, 2013	rg Pointing corrections for Spr+31

;	Mar 07, 2013	rg Pointing corrections for Spr+33

;   Apr 17, 2013	rg  "           "         " Spr+35

; 	Dec 12, 2013	rg			    Fall+03  (nr line 2040)
;	Feb 03, 2014	rg				FAll+05    "
;
;			THIS FILE IS galfux4.pro
;----------------------------------------------------------
...
;Correction coefficients for 3rd order poly for +17 declination range of Spring Sky - rg/08dec2011
if (gfstate.cen_ell_dec[0] gt 15.8 AND gfstate.cen_ell_dec[0] lt 18.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [-16453.760D,       2863.2401D,      -166.04701D,       3.2078326D]
	COEFDEC=[ 97849.837D,      -17035.559D,       988.19822D,      -19.102639D]
endif

;Correction coefficients for 3rd order poly for +19 declination range of Spring Sky - rg/02jul2012
if (gfstate.cen_ell_dec[0] gt 17.8 AND gfstate.cen_ell_dec[0] lt 20.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [-26648.389D,       4452.1998D,      -246.89945D,       4.5430517D]
	COEFDEC=[ 87494.517D,      -14094.299D,       755.91583D,      -13.498670D]
endif

;Correction coefficients for 3rd order poly for +21 declination range of Spring Sky - rg/10jan2012
if (gfstate.cen_ell_dec[0] gt 19.8 AND gfstate.cen_ell_dec[0] lt 22.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [ 1988.6256D,      -207.96491D,       6.1507228D,    -0.038365150D]
	COEFDEC=[-69380.857D,       9827.2849D,      -464.05772D,       7.3049656D]
endif
...
;Correction coefficients for 3rd order poly for +31 declination range of Spring Sky, rg/12feb13
if (gfstate.cen_ell_dec[0] gt 29.999 AND gfstate.cen_ell_dec[0] lt 32.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [-20912.182D,       1805.3125D,      -51.161043D,      0.47306086D]
	COEFDEC=[-214268.97D,       20806.046D,      -673.27141D,       7.2601730D]
endif

;Correction coefficients for 3rd order poly for +33 declination range of Spring Sky, rg/07mar13
if (gfstate.cen_ell_dec[0] gt 31.999 AND gfstate.cen_ell_dec[0] lt 34.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [-217594.26D,       19598.706D,      -588.31269D,       5.8851460D]
	COEFDEC=[ 297341.63D,      -27596.052D,       853.04195D,      -8.7827395D]
endif

;Correction coefficients for 3rd order poly for +35 declination range of Spring Sky, rg/17apr13
if (gfstate.cen_ell_dec[0] gt 33.999 AND gfstate.cen_ell_dec[0] lt 36.2 AND $
    gfstate.cen_ell_ra[0] le 17.0 AND gfstate.cen_ell_ra[0] ge 5.5) then begin

	COEFRA= [ 155254.93D,      -13450.155D,       388.34189D,      -3.7372651D]
	COEFDEC=[-360390.86D,       31150.075D,      -897.21565D,       8.6116871D]
endif
...
;Correction for Dec+11 in the Fall sky  mar2014/rg
if ( gfstate.cen_ell_dec[0] ge 9.8 AND gfstate.cen_ell_dec[0] lt 12.2 AND $
    (gfstate.cen_ell_ra[0] lt 5.0 OR gfstate.cen_ell_ra[0] ge 20.0)) then begin

    ;print, 'New correction for Dec=11 Fall sky'

      coefra=[-7935.5616D,       2207.3681D,      -204.27209D,       6.2876814D]
     coefdec=[-4286.2230D,       1166.3250D,      -105.42615D,       3.1725003D]
endif



;Correction for Dec+13 in the Fall sky; a product of the rg/Am collaboration 02jul09
if ( gfstate.cen_ell_dec[0] ge 11.8 AND gfstate.cen_ell_dec[0] lt 14.2 AND $
    (gfstate.cen_ell_ra[0] gt 18.0 OR gfstate.cen_ell_ra[0] lt 6.0)) then begin
...
;Correction for Dec+23, RA>0h in the Fall sky; rg 060412
if ( gfstate.cen_ell_dec[0] ge 21.8 AND gfstate.cen_ell_dec[0] lt 24.2 AND $
    (gfstate.cen_ell_ra[0] lt 6.0)) then begin

    ;print, 'New correction for Dec=23, 0-4h Fall sky  April 6, 2012/RG'

      coefra=[ 47951.138D,      -6206.2647D,       267.35926D,      -3.8351218D]
     coefdec=[ 85424.153D,      -11042.537D,       475.52612D,      -6.8221453D]
endif

if ( gfstate.cen_ell_dec[0] ge 21.8 AND gfstate.cen_ell_dec[0] lt 24.2 AND $
    (gfstate.cen_ell_ra[0] gt 18.0)) then begin

    ;print, 'New correction for Dec=23, 21-0h Fall sky  April 6, 2012/RG'

      coefra=[ 2056.3605D,      -211.31118D,       6.5602428D,     -0.056623578D]
     coefdec=[-61085.144D,       8209.0756D,      -367.28173D,      5.4704455D]
endif

;Correction for Dec+7 in the Fall sky
    ;print, 'Correction for Dec=07 Fall sky'  [RG:26Jun2012] 
    ; RA=00-03h:
if (gfstate.cen_ell_dec[0] gt 5.8) AND (gfstate.cen_ell_dec[0] lt 8.2) AND $
    (gfstate.cen_ell_ra[0] lt 5.0) then begin

     coefra= [-2760.1811D,       1187.2616D,      -169.20584D,       8.0026920D]
     coefdec=[ 231.84117D,      -102.63115D,       14.744520D,     -0.67589082D]
endif
    ; RA=22-24h:
if  (gfstate.cen_ell_dec[0] gt 5.8) AND (gfstate.cen_ell_dec[0] lt 8.2) AND $
    (gfstate.cen_ell_ra[0] gt 20.0) then begin
     coefra=[-1119.6909D,       502.88641D,      -74.407881D,       3.6419895D]
     coefdec=[2712.1609D,      -1147.9425D,       160.73822D,      -7.4344401D]
endif

;Correction for Dec+5 in the Fall sky
    ;print, 'Correction for Dec=05 Fall sky'  [RG:3feb2014] 
    ; Ra= 22-24hh:
if (gfstate.cen_ell_dec[0] gt 3.8) AND (gfstate.cen_ell_dec[0] lt 6.2) AND $
    (gfstate.cen_ell_ra[0] gt 20.0) then begin

     coefra= [213.73576D,      -134.91566D,       27.897418D,      -1.8844672D]
     coefdec=[-129.93675D,       79.022954D,      -14.376008D,      0.79338050D]
endif
;Correction for Dec+5 in the Fall sky
    ;print, 'Correction for Dec=05 Fall sky'  [RG:3feb2014] 
    ; Ra 00-03h:
if (gfstate.cen_ell_dec[0] gt 3.8) AND (gfstate.cen_ell_dec[0] lt 6.2) AND $
    (gfstate.cen_ell_ra[0] lt 5.0) then begin
     ...
     coefra= [-80.673313D,     35.969819D,      -4.3045997D,     0.078553270D]
     coefdec=[ 78.182859D,    -53.576343D,       13.119797D,      -1.0590235D]
endif

    ; next 00-03h:
;Correction for Dec+3 in the Fall sky
    ;print, 'Correction for Dec=03 Fall sky'  [RG:12Dec2013] 
    ; Ra= 22-24hh:
if (gfstate.cen_ell_dec[0] gt 1.8) AND (gfstate.cen_ell_dec[0] lt 4.2) AND $
    (gfstate.cen_ell_ra[0] gt 20.0) then begin

     coefra= [-39.312615D,       50.942499D,      -18.469600D,       2.0168410D]
     coefdec=[-32.626787D,       42.619956D,      -16.996370D,       2.2136501D]
endif
...
if (gfstate.cen_ell_dec[0] gt 1.8) AND (gfstate.cen_ell_dec[0] lt 4.2) AND $
    (gfstate.cen_ell_ra[0] lt 5.0) then begin
     ...
     coefra= [ 71.644410D,    -67.264303D,       21.490886D,      -2.2898573D]
     coefdec=[-88.135677D,     92.321134D,      -30.760468D,       3.3807345D]
endif
    ; next 00-03h:

;Correction for Dec+1 in the Fall sky
    ;print, 'Correction for Dec=01 Fall sky'  [RG:15Jun2012] 
    ; first 22-24h:
if (gfstate.cen_ell_dec[0] gt -0.5) AND (gfstate.cen_ell_dec[0] lt 2.2) AND $
    (gfstate.cen_ell_ra[0] lt 5.0) then begin

     coefra= [7.4813144D,     -6.5813505D,     -0.29461070D,       1.4666211D]
     coefdec=[2.7850781D,      16.693260D,      -29.303648D,       10.625718D]
endif
    ; next 00-03h:
if  (gfstate.cen_ell_dec[0] gt -0.5) AND (gfstate.cen_ell_dec[0] lt 2.2) AND $
    (gfstate.cen_ell_ra[0] gt 20.0) then begin
     coefra=[0.057890623D,       15.626204D,      -14.079486D,       3.4978130D]
     coefdec=[-4.3791703D,       24.740471D,      -24.506701D,       7.2067442D]
endif
