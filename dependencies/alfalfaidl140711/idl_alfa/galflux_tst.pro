...
;                              degrees declination.
;
;	Jul 3,2009	 RG	extended pointing to Fall+13,+09,+07
;				modified 
...
;				hpfwx=3.3
;				hpfwy=3.8
;				added systime stamp in 'src' structure
;
;
;----------------------------------------------------------
...
if ( gfstate.cen_ell_dec[0] gt 5.5 AND gfstate.cen_ell_dec[0] lt 8.5 AND $
    (gfstate.cen_ell_ra[0] lt 5.0 OR gfstate.cen_ell_ra[0] ge 20.0)) then begin
