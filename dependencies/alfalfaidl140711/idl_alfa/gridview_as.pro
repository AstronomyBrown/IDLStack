...
delvarx, agcnorth, agc, table3D, cattable, table2D, catalog_template
...
getdss, state.currentimage_rahr, state.currentimage_decdeg, imagesize=imagesize
 ...
 check=findfile('checklist.txt', count=count)
    ...
    if (count eq 1) then begin
     ...
     icheck=where(rahr lt ramax AND $
           ...
           (vel lt grid.velarr[channel]+width/2.0 AND $
             vel gt grid.velarr[channel]-width/2.0))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Main program block;;;;;;;;;;;;
pro gridview_as, data, cat3D=cat3D
