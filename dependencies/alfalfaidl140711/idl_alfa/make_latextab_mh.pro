...
;
; CALLING SEQUENCE:
;	make_latextab, input_data, basename
;
; INPUT PARAMETERS:
...
;
; EXAMPLE:
;	> make_latextab, '/home/hatillo/ghallenbeck/a7620/canven_cat.agc', 'canven'
...
;       Martha removes inclusion of catalog index number                      M. Haynes Dec 27, 2010
;-
;
;
...
PRO MAKE_LATEXTAB, input_data, basename
...
;	header2='#                       RA                Dec             RA               Dec        km/s                 Jykm/s                       Mpc     Msun'
	header1=' AGC               HI Coords (J2000)               Opt Coords (J2000)         cz     W50  Werr  Sint   Serr     S/N     RMS      D     log(M) Code'
	header2='               RA                 Dec             RA               Dec        km/s                 Jykm/s                       Mpc     Msun'
...
;  		  format="(i5,'  & ',i6,' & ',a15,' & ',a15,' & ',a15,' & ',a15,' & ',i6,' & ',i5,'(',i3,') & ',f6.2,'(',f4.2,') &',f7.1,' & ',f6.2,' & ',A6,' & ',A6,' & ',i1,2x,' \\')"
                printf,texout,data.AGCnum[i],raH,decH,raO,decO,data.vel[i],raw_data[i].w50,raw_data[i].werr,raw_data[i].flux,raw_data[i].FluxErr,raw_data[i].SN,raw_data[i].rms,distmpc,loghimass,data.code[i],$
  		  format="(i6,' & ',a15,' ',a15,' & ',a15,' ',a15,' & ',i6,' & ',i5,'(',i3,') & ',f6.2,'(',f4.2,') &',f7.1,' & ',f6.2,' & ',A6,' & ',A6,' & ',i1,2x,' \\')"
...
; 		  format="(i5,2x,i6,2x,a15,2x,a15,2x,a15,2x,a15,2x,i6,2x,i5,2x,i3,2x,f6.2,2x,f4.2,2x,f7.1,2x,f6.2,2x,A6,2x,A6,2x,i1)"
                printf,tabout,data.AGCnum[i],raH,decH,raO,decO,data.vel[i],raw_data[i].w50,raw_data[i].werr,raw_data[i].flux,raw_data[i].FluxErr,raw_data[i].SN,raw_data[i].rms,distmpc,loghimass,data.code[i],$
 		  format="(i6,2x,a15,2x,a15,2x,a15,2x,a15,2x,i6,2x,i5,2x,i3,2x,f6.2,2x,f4.2,2x,f7.1,2x,f6.2,2x,A6,2x,A6,2x,i1)"
