...
;				set wmask=0 if the pos.status for reecord is flagged bad
...
;	if you're converting to flux density, gain of beam 0 yields higher weight:
        ...
        for ip=0,1 do begin
          if (pos[posindx].status[ip,nr,near_bm] eq 1) then wmask[ichstart[isec]:ichstop[isec],ip,nr,near_bm]=0.
        endfor
