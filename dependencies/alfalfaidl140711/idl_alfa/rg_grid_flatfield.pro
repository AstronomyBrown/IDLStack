...
; rest of the grid is elft unchanged. This is useful when, foro example, you
...
pro flat_imdisplay,image,fimage,nch,np,nreg=nreg,vel=vel,mapwindow=mapwindow
...
for k=k1,k2 do begin
  ...
  for np=0,npol-1 do begin 
    ...
    flat_imdisplay,image,fimage,nch,np,nreg=this_nreg,vel=velocity,mapwindow=mapwindow
