...
;	catalog file
; 
;SYNTAX: lbwcatalog, dist=dist, filename=filename
;
;ARGS:
;
;OPTIONAL KEYWORDS:
;
;	dist - indicates that user wishes to include distances and HI masses in 
;		ASCII catalog file
...
PRO lbwcatalog, dist=dist, filename=filename
