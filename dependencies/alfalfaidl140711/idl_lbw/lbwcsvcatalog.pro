...
;	catalog file
; 
;SYNTAX: lbwcsvcatalog, dist=dist, filename=filename
;
;ARGS:
;
;OPTIONAL KEYWORDS:
;
;	dist - signifies that the user would like to include source distances and HI
;		masses in their catalog file
...
PRO lbwcsvcatalog, dist=dist, filename=filename
