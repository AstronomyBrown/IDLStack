;+
;NAME:
;  lbwquicklook - check lbw spectra
;SYNTAX: lbwquicklook, file, pol=pol, hires=hires
;ARGS:
...
; 
;Examples:
;  lbwquicklook     ; Open most recent corfile. Only do this while logged in at Arecibo!
;  lbwquicklook, 25 ; Open the most recent corfile ending in *a2707.25 Only do this while logged in at Arecibo!
;  lbwquicklook, '/home/yourstuff/lbw/corfile.12jan16.a2707.25', /pol
...
;-
PRO lbwquicklook, filename=file, pol=pol, hires=hires, smooth=smooth, xrange=xrange, yrange=yrange, vel=vel
...
; Is it the file index? (passed a number)?
	...
	spawn, 'ls -t /share/olcor/corfile.*.a2707.'+strtrim(file,2), files
	file = files[0]
